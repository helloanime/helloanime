        ...
        <div>
            <footer className="bg-[#151518] mt-10">
                    ...
                    <div className="lg:flex lg:justify-between">
                        <div class="mb-6 lg:mb-0">
                            <Link class="flex items-center w-fit" href="/">
                                <p class="HelloAnime self-center !text-4xl tracking-wider font-medium whitespace-nowrap dark:text-white">HelloAnime</p>
                                </Link>
                ...
                <div className="mx-auto w-full lg:max-w-[83%] lg:flex lg:items-center lg:justify-between lg:text-[0.8rem] text-[0.7rem] text-[#ffffffb2] py-3">
                    <span className="sm:text-center ms-5 lg:ms-0">© {year} <Link href="/" className="hover:text-white">HelloAnime™</Link> | Made by <span className="font-bold" >HelloAnime Team</span>
                    </span>
